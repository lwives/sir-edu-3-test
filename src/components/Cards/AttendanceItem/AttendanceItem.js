    ...
    render() {
        ...
        return (
            <div className="attendance-item">
                ...
                <Modal show={this.state.open} onHide={this.close} backdrop="static" dialogClassName="attendance-modal">
                    <Modal.Header closeButton>
                        <Modal.Title>Visualizar Adequação</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <div className="attendance-content">
                            <Paper className="container-fluid attendance-text" zDepth={4}>
                                <div className="row">
...
export default connect(mapStateToProps, {})(AttendanceItem)
