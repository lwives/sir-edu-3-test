...
class AdaptationItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            open: false
    ...
    render() {
        ...
        return (
            <div className="adaptation-item">
                ...
                <Modal show={this.state.open} onHide={this.close} backdrop="static" dialogClassName="adaptation-modal">
                    <Modal.Header closeButton>
                        <Modal.Title>Visualizar Adequação</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <div className="adaptation-content">
                            <Paper className="container-fluid adaptation-text" zDepth={4}>
                                <div className="row">
...
export default connect(mapStateToProps, {})(AdaptationItem)
