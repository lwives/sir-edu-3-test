                ...
                {this.props.step === 0 &&
                    <div className="col-md-12">
                        ...
                        <div className="col-md-8">
                            ...
                            <TextField fullWidth value={this.register.motherPhone || ''} type="number" name="phoneNumber" onChange={this.handleChange} floatingLabelText="Telefone na Mãe:" />
                        </div><div className="col-md-4">
                            <TextField fullWidth value={this.register.motherEmail || ''} type="email" name="email" onChange={this.handleChange} floatingLabelText="E-mail da Mãe:" />
                        </div><div className="col-md-6">
                            <TextField fullWidth value={this.register.fatherName || ''} type="text" name="fatherName" onChange={this.handleChange} floatingLabelText="Nome do Pai:" />
                        </div><div className="col-md-2">
                            <TextField fullWidth value={this.register.fatherPhone || ''} type="number" name="phoneNumber" onChange={this.handleChange} floatingLabelText="Telefone do Pai:" />
                        </div><div className="col-md-4">
                            <TextField fullWidth value={this.register.fatherEmail || ''} type="email" name="email" onChange={this.handleChange} floatingLabelText="E-mail do Pai:" />
                        </div><div className="col-md-4">
                            ...
                            <TextField fullWidth value={this.register.relationship || ''} type="text" name="relationship" onChange={this.handleChange} floatingLabelText="Parentesco:" />
                        </div><div className="col-md-2">
                            <TextField fullWidth value={this.register.responsiblePhone || ''} type="number" name="fatherPhone" onChange={this.handleChange} floatingLabelText="Telefone do Respons.:" />
                        </div><div className="col-md-4">
                            <TextField fullWidth value={this.register.responsibleEmail || ''} type="email" name="fatherEmail" onChange={this.handleChange} floatingLabelText="E-mail do Responsável:" />
                        </div><div className="col-md-6">
                            ...
                            <TextField fullWidth value={this.register.adress2 || ''} type="text" name="adress2" onChange={this.handleChange} floatingLabelText="Endereço 2:" />
                        </div><div className="col-md-4">
                ...
                {this.props.step === 1 &&
                    <div className="row">
                        <div className="col-md-4">
                            ...
                            <TextField fullWidth value={this.register.registration || ''} type="text" name="registration" onChange={this.handleChange} floatingLabelText="Matrícula:" />
                        </div><div className="col-md-4">
                            <TextField fullWidth value={this.register.classNumber || ''} type="text" name="classNumber" onChange={this.handleChange} floatingLabelText="Turma:" />
                        </div><div className="col-md-4">
                            <TextField fullWidth value={this.register.shift || ''} type="text" name="shift" onChange={this.handleChange} floatingLabelText="Turno:" />
                        </div><div className="col-md-4">
                            ...
                            <TextField fullWidth multiLine value={this.register.routingReason || ''} type="text" name="routingReason" onChange={this.handleChange} floatingLabelText="Motivo do encaminhamento a AEE/SR:" />
                        </div>
                    </div>
                }
                {this.props.step === 2 &&
